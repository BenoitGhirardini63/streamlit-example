               ...
               if _file:
                    ...
                    if "Catalogue" in verif_file:
                         ...
                         if st.button("Installer la base de données Catalogue"):
                              ...
                              stud_data.to_sql(table, _bdd, if_exists="replace", index=False) #Exportation du fichier .csv vers la base de données
                              sleep(0.5)
               ...
               with col4:
                    ...
                    if st.button("Mise à jour tables personnes"):
                         ...
                         if update_db_workflow == None:
                              ...
                              install._init3(self, finalisation=True)
                         else:
                              st.write(update_db_workflow)


     def _init3(self, finalisation):
